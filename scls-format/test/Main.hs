...
import Codec.CBOR.Cuddle.CDDL (Name (..), CDDL)
...
import System.Random.Stateful (globalStdGen, applyAtomicGen)
import System.IO.Temp ( withSystemTempDirectory )
import Cardano.SCLS.Internal.Serializer.MemPack
import Test.HUnit

main :: IO ()
main = runTestTTAndExit tests where
    tests = TestList
      [ roundTriptests
    ...
    roundTriptests = TestLabel "Roundtrip tests" $ TestList
            ...
            Right mt -> withSystemTempDirectory "scls-format-test-XXXXXX" $ \fn -> do
                ...
                withNamespacedData
                  ...
                  (\stream -> do
                      ...
                      assertEqual "Stream roundtrip successful"
